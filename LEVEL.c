/* Extracts level data from the Dangerous Dave binary
...
int main(int argc, char* argv[]) 
{
	...
	/* Stream dlevel data to memory and output files */
	FILE *fout;
	char file_num[4];
	char fname[12];
	uint32_t i, j, k;
	...
	/* Create a map of the world by level, row, and column */
	SDL_Surface *map;
	SDL_Rect dest;
	uint8_t tile_index;
